...
def main(argv):
    ...
    json_file_path = "data/IJMOND_VID/metadata_ijmond_jan_22_2024.json"

    # Specify the path that we want to store the videos and create it
    download_path = "data/IJMOND_VID/videos/"
    ...
    problem_videos = []
    for v in data_dict:
        if v["label_state_admin"] != 23 and v["label_state_admin"] != 47:
            continue
