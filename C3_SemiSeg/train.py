...
import C3_SemiSeg.dataloaders as dataloaders
import models
from C3_SemiSeg.trainer import create_trainer
from C3_SemiSeg.utils import losses
from C3_SemiSeg.utils.dist_utils import print_dist_information
from C3_SemiSeg.utils.misc import set_seed
...
if __name__ == '__main__':
    ...
    config = json.load(open(args.config)) # todo fix error
